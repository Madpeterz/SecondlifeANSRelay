...
{
    error_log('A: ' . $message, 3, '/proc/self/fd/2');
    error_log('B: ' . $message, 3, 'php://stdout');
    error_log('C: ' . $message, 3, '/dev/stderr');
}
